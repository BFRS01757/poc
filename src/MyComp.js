...
export default function MyComp({ name, logo, company_name }) {
    console.log(logo);
    return (
        <div className="w-full max-w-sm px-3 py-6 sm:w-1/2 lg:w-1/3">
            <div className="overflow-hidden bg-white rounded-lg shadow-xl">
                <div className="h-56 p-4 bg-center bg-cover" style={{ "backgroundImage": `url(${logo})` }}>
                ...
                <div className="px-4 pt-3 pb-4 bg-gray-100 border-t border-gray-300">
                    ...
                    <div className="flex items-center pt-2">
                        <div className="w-10 h-10 mr-3 bg-center bg-cover rounded-full" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1500522144261-ea64433bbe27?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=751&q=80')" }}>
                        </div>
                        <div>
